  ...
  return (
    <>
      {mobileScreen ? (
        ...
        <header className="w-full lg:max-w-[1440px] mx-auto fixed top-0 right-0 border-b border-[#999F9933] left-0 z-30 bg-white px-5 py-3 flex justify-between items-center">
