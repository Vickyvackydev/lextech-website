        ...
        Our Academy trains and certifies a large pool of verbatim reporters<br className="hidden sm:block" />and scopists to serve both the Nigerian and African markets
          ...
          loading="lazy"
              ...
              <div className= "flex flex-col gap-y-5 w-auto whitespace-normal break-words mt-5 text-[#002A7F]">
                <p className=" whitespace-normal break-words">. Our skilled verbatim reporters with advanced CAT systems capture entire proceedings during depositions and court sessions. With a court reporter, the judge can pay more attention to demeanor during proceedings and manage the court without undue distraction and stress of writing in longhand.</p>
...
<div className= "flex flex-col gap-y-5 w-auto mt-5 text-[#002A7F] whitespace-normal break-words">
                <p className=" whitespace-normal break-words">. Verbatim reporting makes available accurate records ofcourt proceedings from recorded audios. This assures the judge, lawyers, and their clients of the accuracy of the records of the proceedings.</p>
