        ...
        <img
          ...
          loading="lazy"
            ...
            <div className="pl-5 whitespace-normal break-words">
              ...
              Get answers you can bank <br/> on <span className="font-bold"> WHEREVER YOU ARE</span> with just a few clicks!
              </p>
        ...
        <span className="">
          ...
          loading="lazy"
              />            
                ...
                <div className="">
                <p className="text-[#1D1E2A99] text-[16px] font-normal max-w-[734px]">
                Condensed in a simple, clear and concise way – with relevant legal information that you can apply within seconds.                    </p>
                </div>   
            </div> 
