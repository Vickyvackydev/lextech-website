    ...
    <Layout>
      ...
      <div className="flex flex-col justify-center items-center w-auto lg:max-w-[1500px]  p-10 gap-y-5 mx-auto">
        <p className="text-[20px] text-[#002A7F] whitespace-normal break-words">
          ...
          innovative solutions. Positioned at the convergence of legal
          technology, technology consulting, and management consulting, we
          specialize in end-to-end project management and consulting, ensuring
          unparalleled outcomes for our clients
        </p>

        <p className="text-[20px] text-[#002A7F] whitespace-normal break-words">
          Under the mantle of management consulting, LexTech takes pride in
          offering a diverse array of services focused on comprehensive business
          transformation.
        </p>
