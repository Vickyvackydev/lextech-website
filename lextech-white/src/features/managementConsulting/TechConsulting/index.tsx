          ...
          <div className="mt-5">
            ...
            <div className="flex flex-col gap-y-10 mt-8 w-auto p-3">
              <p className="text-[#1D1E2A99] text-[16px] font-normal">
                ...
                of technological advancements. We offer comprehensive strategies
                and solutions that empower businesses to harness cutting-edge
                technologies effectively. Our goal is to seamlessly integrate
                these advancements into existing frameworks, driving operational
                  ...
                  <div className="">
                    <p className="text-[#1D1E2A99] text-[16px] font-normal max-w-[734px] leading-[28.8px]">
                      <span className="text-black text-[16px] font-bold">
                        {" "}
                        Created to bNeeds Assessments (Consultation):
                      </span>{" "}
                      <br />
                      Registry staff easily receive and review all cases filed
                      through the electronic filing system after confirmation of
                      payment. Cases approved as properly filed are
                      electronically presented to the Chief Judge for
                      assignment. When electronically assigned by the Chief
                      Judge, these cases are transferred to the electronic
                      docket of the designated courts for adjudication.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex flex-row items-start gap-x-4">
                  ...
                  <div className="">
                    <p className="text-[#1D1E2A99] text-[16px] font-normal max-w-[734px] leading-[28.8px]">
                      ...
                      <br />
                      Creating a clear, achievable plan outlining the
                      integration of new technologies and their impact on your
                      business processes.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex flex-row items-start gap-x-4">
                  ...
                  <div className="">
                    <p className="text-[#1D1E2A99] text-[16px] font-normal max-w-[734px] leading-[28.8px]">
                      ...
                      <br />
                      Executing seamless integration of solutions to optimise
