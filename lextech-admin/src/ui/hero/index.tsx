...
function Hero() {
  ...
  return (
    <main className="bg-[#0D0769] lg:px-10 px-4 py-14">
      <div className="flex flex-col items-start gap-y-7 mt-9">
        ...
        <span className="text-[#ECF3FF] lg:text-[84.96px] text-2xl lg:leading-[90px] leading-[30px] ">
        ...
        {/* <span className="lg:text-[25.92px] text-[16px] font-normal text-[#002A7F]">
          ...
          critical touchpoints of theJustice sector.
        </span>
        <Button
          title="Contact sales"
        ...
        {!mobilescreen ? (
          ...
          >
            {hovercontents.map((item, i) => (
              <SwiperSlide className=" rounded-lg relative" key={item.id}>
