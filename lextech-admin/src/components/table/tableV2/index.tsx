...
function TableComponentV2({ DATA, COLUMNS }: TableProps) {
  ...
  return (
    <div className="w-full">
      ...
      >
        <thead className="w-full text-start bg-[#EDF2F7]">
            ...
            >
              {headerGroup.headers.map((column: any) => (
                <th
                  ...
                  className="whitespace-nowrap text-left text-[#4A5568] pl-6 pr-3 pt-3 pb-2 text-sm font-semibold"
                >
            ...
            return (
              ...
              >
                {row.cells.map((cell: any) => (
                  <td
                    {...cell.getCellProps()}
                    className="pl-6 pr-3 py-6 text-sm text-[#718096]"
                  >
                    {cell.render("Cell")}
                  </td>
                ))}
